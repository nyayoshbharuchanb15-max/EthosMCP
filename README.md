...
2.  **[ARCHITECTURE.md](./ARCHITECTURE.md):** Enterprise-grade architectural reference with Mermaid data-flow diagrams, component breakdown, and full legal mapping.
3.  **[AUDITING_FRAMEWORK.md](./AUDITING_FRAMEWORK.md):** The technical blueprint demonstrating the four-phase deterministic audit methodology, cryptographic verification, and DSAR simulation.
